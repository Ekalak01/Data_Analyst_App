...
class RangeSlider(QtWidgets.QSlider):
    ...
    minimumChanged = QtCore.pyqtSignal(str)
    maximumChanged = QtCore.pyqtSignal(str)
    ...
    def mouseMoveEvent(self, event):
        ...
        self.minimumChanged.emit(str(self._low))
        
        self.maximumChanged.emit(str(self._high))
        
        #print(self._high,self._low)
